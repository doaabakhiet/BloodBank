        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5 pt-3">
                    <form action="{{ Route('dashboard.clients.index') }}" method="get" id="form">
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <div class="form-check">
                                                {{-- <form action="{{Route('dashboard.client.toggleActive') }}" method="post">
                                                    @csrf --}}
                                                <input type="hidden" name="clientID" value="{{ $item->id }}" />
                                                {{-- <input class="form-check-input" type="checkbox"
                                                    value="{{ $item->isactive }}" name="active"
                                        ...
                                        <td>
                                            {!! Form::open([
                                                'route' => ['dashboard.clients.destroy', $item->id],
                                                'method' => 'delete',
                                                'class' => 'delete-form',
                                            ]) !!}
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        elems.forEach(function(html) {
            var switchery = new Switchery(html,{ color: 'rgb(80 111 237)', jackColor: '#9decff' });
        });
        var confirmed = false;
