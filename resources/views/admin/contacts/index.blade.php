...
<section class="content">
    ...
    <div class="card">
            ...
            <div class="row">
                <div class="col-sm-5 pt-3">
                    <form action="{{ Route('dashboard.contacts.index') }}" method="get" id="form">
                        <div class="form-group has-search" title="Press Enter">
                            ...
                            <tbody>
                                @foreach ($contacts as $item)
                                    <tr class="odd">
                                        ...
                                        <td class="dtr-control sorting_1" tabindex="0">{{ $item->clients->email }}
                                        </td>
        ...
        @else
        <div class="alert alert-danger">No Contacts</div>
        @endif
        <!-- /.card-body -->
