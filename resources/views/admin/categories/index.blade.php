...
<section class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><a href="{{ Route('dashboard.categories.create') }}"
                            ...
                            <tbody>
                                @foreach ($categories as $item)
                                    <tr class="odd">
                                        ...
                                        <td><a href="{{ Route('dashboard.categories.edit', $item->id) }}"
                                                class="btn btn-primary"><i class="fa fa-pen"></i></a></td>
                                        <td>
                                            {!! Form::open([
                                                'route' => ['dashboard.categories.destroy', $item->id],
                                                'method' => 'delete',
                                                'class' => 'delete-form',
                                            ]) !!}
