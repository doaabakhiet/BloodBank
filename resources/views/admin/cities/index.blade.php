...
<section class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><a href="{{ Route('dashboard.cities.create') }}"
                            ...
                            <tbody>
                                @foreach ($cities as $item)
                                    <tr class="odd">
                                        ...
                                        <td>{{$item->governates->name}}</td>
                                        <td><a href="{{ Route('dashboard.cities.edit', $item->id) }}"
                                                class="btn btn-primary"><i class="fa fa-pen"></i></a></td>
                                        <td>
                                            {!! Form::open([
                                                'route' => ['dashboard.cities.destroy', $item->id],
                                                'method' => 'delete',
                                                'class' => 'delete-form',
                                            ]) !!}
