...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('bloodtype_client', function(Blueprint $table) {
			$table->foreign('client_id')->references('id')->on('clients')
						->onDelete('cascade')
						->onUpdate('cascade');
		});
	...
	{
		Schema::table('clients', function(Blueprint $table) {
			$table->dropForeign('clients_bloodtype_id_foreign');
		});
		Schema::table('clients', function(Blueprint $table) {
		...
		Schema::table('bloodtype_client', function(Blueprint $table) {
			$table->dropForeign('bloodtype_client_client_id_foreign');
		});
		Schema::table('bloodtype_client', function(Blueprint $table) {
			$table->dropForeign('bloodtype_client_bloodtype_id_foreign');
		});
		Schema::table('notification_governate', function(Blueprint $table) {
			$table->dropForeign('notification_governate_client_id_foreign');
		});
		Schema::table('notification_governate', function(Blueprint $table) {
			$table->dropForeign('notification_governate_governate_id_foreign');
		});
		Schema::table('client_notification', function(Blueprint $table) {
